...
function Spark() {
this.content = function(element, content, append) {
...
this.cookie = function(name, content, duration) {
	if(content === undefined)
	{
...
this.event = function(element, type, callback) {
	if(typeof element == 'string')
		element = Sizzle(element);
	for(var e in element)
	{
...
this.size = function(element, width, height, timeframe, callback) {
	if(typeof element == 'string')
		element = Sizzle(element);
	for(var e in element)
	{
...
this.value = function(element, content, append) {
	if(typeof element == 'string')
		element = Sizzle(element);
	for(var e in element)
	{
...
this.visible = function(element, visible) {
	if(typeof element == 'string')
		element = Sizzle(element);
	for(var e in element)
	{
...
this.opacity = function(element, opacity, timeframe, callback) {
	if(typeof element == 'string')
		element = Sizzle(element);
	for(var e in element)
	{
...
this.link = function(element, find, link) {
	if(typeof element == 'string')
		element = Sizzle(element);
	for(var e in element)
	{
...
this.ajax = function(method, file, data) {
...
this.transition = function(element, transition, timeframe, callback) {
	if(typeof element == 'string')
		element = Sizzle(element);
