...
if(callback!==undefined)
{var callbackTimer=setTimeout(callback,100*steptime);}}}};this.object=function(element){return document.querySelectorAll(element)[0];};this.transition=function(element,transition){};}
var s=new Spark()